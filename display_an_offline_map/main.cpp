...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<MapQuickView>("Esri.display_an_offline_map", 1, 0, "MapView");

    // Register the Display_an_offline_map (QQuickItem) for QML
    qmlRegisterType<Display_an_offline_map>("Esri.display_an_offline_map", 1, 0, "Display_an_offline_map");
